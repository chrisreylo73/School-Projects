...
public class Molecule {
    ...
    public boolean isEmpty() { return head == null; // placeholder so the code compliles
    }
    ...
    public void add(final Element element, int amount) {
        ...
        if (duplicateElement == false) {
            ...
            if(head == null) {
            ...
            else if (this.head.getElement().getAtomLetter().equals("C") && newNode.getElement().getAtomLetter().equals("H")) {
                ...
                while (runner != null && newNode.getElement().getAtomLetter().compareTo(runner.getElement().getAtomLetter()) > 0){
